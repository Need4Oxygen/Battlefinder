...
namespace Trello
{
    public class TrelloAPI
    {
        ...
        public List<object> PopulateBoards()
        {
            ...
            var boardsDict = Json.Deserialize<Dictionary<string, object>>(www.downloadHandler.text) as Dictionary<string, object>;
        ...
        public List<object> PopulateLists()
        {
            ...
            var listsDict = Json.Deserialize<Dictionary<string, object>>(www.downloadHandler.text) as Dictionary<string, object>;
        ...
        public TrelloCard UploadCard(TrelloCard card)
        {
            ...
            NotificationManager.Instance.Notify(NotifColors._green, NotifSprites._tick, "Feedback Successfully sent!", 2f, 0f);
            return card;
        }
    }
}