...
namespace Pathfinder2e.Player
{
    ...
    public class CharacterCreation : MonoBehaviour
    {
        ...
        private void ChoiceButtonsAssigner(BuildBlock buildItem, PF2E_BuildButton button)
        {
        ...
        private void NoChoiceButtonsAssigner(BuildBlock buildItem, PF2E_BuildButton button)
        {
            // button.title.text = buildItem.type;
            // button.subtitle.text = buildItem.value;
        }
